...
type Props ={
    onCreate: (date:TaskInsert) => Promise<void>;
};
        ...
        <form onSubmit={submit} className="bg-slate-900 border border-slate-800 rounded-xl p-4 space-y-3">
            <div className="grid grid-cols-2 gap-3">
                ...
                <div className="md:col-span-2">
                    ...
                    <textarea className="mt-1 w-full px-3 py-2 rounded-lg bg-slate-950 border border-slate-800"
                    value={description}
                    onChange={(e) => setDescription(e.target.value)}
                    placeholder="例:まるまる者向け期限は金曜"
                    rows={3}
                    />
                </div>
                ...
                <div>
                    ...
                    <select className="mt-1 w-full px-3 py-2 rounded-lg bg-slate-950 border border-slate-800"
            ...
            <button className="px-4 py-2 rounded-lg bg-emerald-600 hover:bg-emerald-500 disabled:opacity-60"
